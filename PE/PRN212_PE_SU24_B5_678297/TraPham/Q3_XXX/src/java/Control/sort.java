...
public class sort extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String typeIndex1 = request.getParameter("typeIndex");
        ExeDAO dao  = new ExeDAO();
        ArrayList<Exe> list = dao.getExe(typeName1,typeIndex1);
        
        request.setAttribute("typeIndex1", typeIndex1);
        request.setAttribute("typeName1", typeName1);
