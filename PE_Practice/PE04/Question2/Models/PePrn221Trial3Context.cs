...
public partial class PePrn221Trial3Context : DbContext
{
    public PePrn221Trial3Context()
    {
    }

    public PePrn221Trial3Context(DbContextOptions<PePrn221Trial3Context> options)
        : base(options)
    {
    }
